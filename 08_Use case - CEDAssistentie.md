...
**Aanleiding**
* Digitale assistentie ontwikkelt zich in hoog tempo van een reactieve naar een proactieve vorm. Ze wordt steeds autonomer, kan complexere taken uitvoeren en beschikt over een groeiend leervermogen. Deze nieuwe generatie digitale assistentie willen we integrale verkenning waarin we gericht bewijs verzamelen om onzekerheden over het **C**entrum **E**ducatieve **D**igitale **A**ssistentie binnen het vervolgonderwijs zo snel mogelijk weg te nemen.
...
* …is lokaal en flexibel: het is ontworpen om op de eigen infrastructuur van de instelling te draaien, wat voordelen biedt voor privacy en aanpasbaarheid ten opzichte van cloud-gebaseerde alternatieven.

* …is open-source: het biedt IR‑medewerkers de vrijheid om de functionaliteit uit te breiden of te integreren in eigen systemen.
...
* De Digitale Assistent (/AI‑agent) kan worden hergebruikt voor vergelijkbare beleidsvragen.
...
4. De IR-medewerker typt of spreekt de juiste formulering van de te beantwoorden vraag in.
5. Het ecosysteem verifieert of de Digitale Assistent (/AI‑agent) toegang mag krijgen tot de gevraagde datasets.
