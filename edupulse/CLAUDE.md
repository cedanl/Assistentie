...
This file provides guidance to Claude Code (claude.ai/code) when working in `edupulse/`.

Behavioral guidelines (Think Before Coding, Simplicity First, Surgical Changes, Goal-Driven Execution) live in the **root `CLAUDE.md`** — they apply here too. Only project-specific guidance is kept below.
