...
def train_model(
    ...
    joblib.dump(
        {"model": best_model, "encoders": encoders, "feature_medians": feature_medians}, model_path
    )
...
if __name__ == "__main__":
    ...
    train_model(
        df, model_path=f"{data_dir}/model.pkl", feature_path=f"{data_dir}/feature_list.json"
    )
